...
const navItems = [
  { to: '/', icon: '⌂', labelKey: 'home', end: true },
  { to: '/proyectos', icon: '⊞', labelKey: 'projects' },
  { to: '/experiencia', icon: '◈', labelKey: 'experience' },
  { to: '/resumen', icon: '⎙', labelKey: 'resume' },
]
